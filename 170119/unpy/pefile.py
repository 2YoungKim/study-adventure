...
Processed elements such as the import table are made available with ascii_lowercase
...
class Structure:
    ...
    def __unpack__(self, data):
        ...
        if data.count(bytes(chr(0), 'UTF-8')) == len(data):
...
class PE:
    ...
    def get_imphash(self):
        ...
        return hashlib.md5( ','.join( impstrs ).encode() ).hexdigest()
    ...
    def generate_checksum(self):
        ...
        data = bytes(self.__data__, 'UTF-8')
